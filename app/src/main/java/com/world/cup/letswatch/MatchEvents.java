...
public class MatchEvents extends AppCompatActivity {
    ...
    private GameViewEventAdapter matchesAdapters;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        matchesAdapters=new GameViewEventAdapter(this,matchModelList);
    ...
    private void getData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(ApiUrl.base_url, new com.android.volley.Response.Listener<JSONArray>() {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("x-rapidapi-key", "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
